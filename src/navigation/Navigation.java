        ...
        while (true) {
            ...
            switch (choice) {
                case 0:
                    ...
                    return;
                case 1:
                    RegisterNavigation registerNavigation = new RegisterNavigation(scanner, accountService);
                    registerNavigation.register();
                    break;
                case 2:
                    LoginNavigation loginNavigation = new LoginNavigation(scanner, accountService);
                    loggedInAccount = loginNavigation.login();
                    if (loggedInAccount != null) {
                        id = accountService.getLoggedInClientId();
                        accountMenu();
                    }
                    break;
                default:
